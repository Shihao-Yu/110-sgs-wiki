...
OWNERS = {
    ...
    # 蒲元「铸刃」：弃一张手牌换一张同花色的装备，【天雷刃】须弃【闪电】获得。
    # 这五把正好是四花色各一把（水波剑♣/混毒弯匕♠/烈淬刃♦/红缎枪♥）加上天雷刃，
    # 与技能描述完全吻合。除天雷刃外的四把在 OCR 文本里没有被点名——铸刃的描述
    # 用的是"与你弃置牌花色相同的装备"这种泛指，不列举牌名，靠搜索查不出来。
    "天雷刃":   "general_qlhd_shu_059",
    "水波剑":   "general_qlhd_shu_059",
    "混毒弯匕": "general_qlhd_shu_059",
    "烈淬刃":   "general_qlhd_shu_059",
    "红缎枪":   "general_qlhd_shu_059",
    # 刘协「帝召」：视为使用一张【敕令】
